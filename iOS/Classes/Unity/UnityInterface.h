...
// rendering
	...
	extern void*	UnityCreateUpdateExternalColorSurfaceGLES(int api, void* surf, unsigned texid, unsigned rbid, int width, int height, bool is32bit, int samples, bool backbuffer);
	extern void*	UnityCreateUpdateExternalDepthSurfaceGLES(int api, void* surf, unsigned texid, unsigned rbid, int width, int height, bool is24bit, int samples, bool backbuffer);
#endif

extern void*	UnityCreateExternalSurfaceMTL(void* surf, int isColor, MTLTextureRef tex, const UnityRenderBufferDesc* desc);
extern void*	UnityCreateExternalColorSurfaceMTL(void* surf, MTLTextureRef tex, MTLTextureRef resolveTex, const UnityRenderBufferDesc* desc);
extern void*	UnityCreateExternalDepthSurfaceMTL(void* surf, MTLTextureRef tex, MTLTextureRef stencilTex, const UnityRenderBufferDesc* desc);
extern void*	UnityCreateDummySurfaceMTL(void* surf, int isColor, const UnityRenderBufferDesc* desc);
extern void		UnityDestroyExternalSurfaceMTL(void* surf);
void			UnityStartMetalFrame(void* colorRB, void* depthRB, int frameNumber);
MTLCommandBufferRef UnityPrepareEndMetalFrame();
void			UnityFinishedMetalFrame(int frameNumber);
void			UnitySetAsDefaultFBOMetal(void* color, void* depth);
void			UnitySetFBOMetal(void* color, void* depth);
...
extern void		UnityDestroyExternalColorSurfaceGLES(int api, void* surf);
extern void		UnityDestroyExternalDepthSurfaceGLES(int api, void* surf);
...
extern int			UnitySelectedRenderingAPI();
extern EAGLContext*	UnityGetMainScreenContextGLES();
extern EAGLContext*	UnityGetDataContextEAGL();

extern NSBundle*			UnityGetMetalBundle();
extern MTLDeviceRef			UnityGetMetalDevice();
extern MTLCommandQueueRef	UnityGetMetalCommandQueue();
extern MTLCommandBufferRef	UnityGetCommandBufferMetal();
...
extern void		UnityReportBackbufferChange(void* colorBB, void* depthBB);
...
extern void		UnityReportAVCapturePermission();
extern void		UnityDidCaptureVideoFrame(intptr_t tex, void* udata);
